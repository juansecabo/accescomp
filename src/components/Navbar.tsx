          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              {canInstall && (
                <button
                  onClick={installApp}
                  className="px-2 sm:px-3 py-1.5 sm:py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-all duration-200 text-[10px] sm:text-sm flex items-center gap-1"
                >
      ...
      {showIOSModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-sm mx-4 p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Instalar en iPhone/iPad</h2>
            <ol className="space-y-3 text-sm text-gray-700">
              <li className="flex items-start gap-2">
                <span className="font-bold text-blue-600">1.</span>
                <span>Toca el botón <strong>Compartir</strong> (el cuadrado con la flecha hacia arriba) en Safari</span>
              </li>
              <li className="flex items-start gap-2">
            ...
            <button
              ...
              className="w-full mt-5 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors"
            >
              Entendido
            </button>
          </div>
